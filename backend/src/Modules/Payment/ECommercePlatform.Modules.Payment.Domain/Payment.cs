...
/// <summary>
/// Aggregate root for a single order's payment. One Payment per Order (created lazily on the
/// first charge attempt — see <c>ProcessPaymentCommandHandler</c>), holding every attempt made
/// against it in <see cref="Transactions"/>.
///
